...
#if (CHIP_REV == S3L) && defined(CONFIG_PLAT_AMBARELLA_AMBALINK)
/* S3L's SD1 base is moved to offset 0x1F000. */
/* Redefine the SD1_BASE for ambalink sd driver. */
#undef SD1_BASE
#define SD1_BASE			(SD2_BASE)
#endif
