...
#define VIC_SOFT_IRQ(x)             	VIC2_INT_VEC((x) + 10)	/* 0 <= x <= 13 */
...
#define VIC_SOFT_IRQ(x)             	VIC2_INT_VEC((x) + 5)	/* 0 <= x <= 13 */
...
/* ==========================================================================*/
#elif (CHIP_REV == S3)
#define VIC_SOFT_IRQ(x)             	VIC0_INT_VEC((x))	/* 0 <= x <= 6 */
...
#define VIC_SOFT_IRQ2(x)             	VIC0_INT_VEC((x + 16))	/* 0 <= x <= 7 */
...
#define VIC_SOFT_IRQ(x)             	VIC0_INT_VEC((x) + 7)	/* 0 <= x <= 13 */
