...
#elif (CHIP_REV == S3)
#define SYSTEM_TIMER_IRQ		126

#define BOSS_VIRT_TIMER_INT_VEC		VIC_SOFT_IRQ2(0) /* Virtual 'timer' to guest irq */
#define BOSS_VIRT_GIRQ_INT_VEC		VIC_SOFT_IRQ2(1) /* Virtual 'guest IRQ' irq */
#define BOSS_VIRT_RIRQ_INT_VEC		VIC_SOFT_IRQ2(2) /* Virtual 'root IRQ' irq */
#else
#error "Boss is not supported on this chip!"
#endif

#if (CHIP_REV == S2) || (CHIP_REV == S2L) || (CHIP_REV == S2E) || (CHIP_REV == S3) || (CHIP_REV == S3L)
